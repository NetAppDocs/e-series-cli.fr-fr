...
---
= Commandes de configuration de la baie SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La liste suivante des commandes de configuration de baie est disponible pour votre système de stockage E-Series.
...
link:../commands-a-z/set-storagearray-host-io-protocol.html["Définir le protocole d'E/S de l'hôte de la baie de stockage"]
...
link:../commands-a-z/show-storage-array-host-io-protocol.html["Afficher le protocole d'E/S de l'hôte de la baie de stockage"]
