...
Si la gestion des clés externes est activée, cette commande s'applique uniquement aux baies E4000, E2800, E5700, EF600, EF300, EF50 ou EF80. Si la gestion des clés internes est activée, la commande s'applique à toute baie de stockage individuelle, à condition que tous les packages SMcli soient installés.
