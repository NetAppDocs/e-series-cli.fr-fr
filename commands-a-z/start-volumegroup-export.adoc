...
[CAUTION]
====
N’effectuez pas ces étapes sans avoir préalablement effectué les étapes énumérées dans xref:../get-started/learn-about-volume-group-migration.adoc[En savoir plus sur la migration de groupes de volumes.]
