...
summary: La commande démarrer la reconstruction du lecteur commence à reconstruire un lecteur. 
---
= Démarrer la reconstruction du lecteur - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Le `start drive reconstruct` la commande commence à reconstruire un lecteur.
