...
Le tableau suivant répertorie les modifications apportées aux commandes CLI et Script Commands pour la version 12.00.
...
| Commande | Description de la modification 
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/set-storagearray-host-io-protocol.html["Définir le protocole d'E/S hôte de la baie de stockage"]
 a| 
Commande ajoutée.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/show-storage-array-host-io-protocol.html["Afficher les informations du protocole d'E/S de l'hôte de la baie de stockage"]
 a| 
Commande ajoutée.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/start-storagearray-externalkeymanagement-test.html["Tester la communication externe de gestion des clés"]
 a| 
Ajouté les résultats du test de communication KMS à la sortie de la commande.



 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/set-storagearray-managementinterface.html["Définissez l'interface de gestion des baies de stockage"]
 a| 
Commande supprimée.
...
Mise à jour `disableResourceProvisioning` description du paramètre.
 ...
 a| 
xref:./commands-a-z/recreate-storagearray-securitykey.adoc[Recréez la clé de sécurité externe]
 a| 
